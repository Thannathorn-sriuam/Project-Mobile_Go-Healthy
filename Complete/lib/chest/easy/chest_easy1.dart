...
class chest_easy extends StatelessWidget {
  const chest_easy({Key? key}) : super(key: key);
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Image.asset('assets/gif/chest/easy1.gif'), // ใช้ GIF แทนภาพปก
          ),
          SizedBox(height: 10),
          Text(
            'Reverse Fly',
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Image.asset('assets/gif/chest/easy2.gif'), // ใช้ GIF แทนภาพปก
          ),
          SizedBox(height: 10),
          Text(
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Image.asset('assets/gif/chest/easy3.gif'), // ใช้ GIF แทนภาพปก
          ),
          SizedBox(height: 10),
          Text(
